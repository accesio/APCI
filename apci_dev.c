...
#define APCI_MAKE_ENTRY(X, RELAY, INPUT)     \
	{                                    \
		X, 0, RELAY, INPUT, NAME_##X \
	}
...
static struct apci_lookup_table_entry apci_driver_table[] =
    APCI_MAKE_DRIVER_TABLE(
        APCI_MAKE_ENTRY(PCIe_DIO_24,0,0),
        APCI_MAKE_ENTRY(PCIe_DIO_24D,0,0),
        APCI_MAKE_ENTRY(PCIe_DIO_24S,0,0),
        APCI_MAKE_ENTRY(PCIe_DIO_24DS,0,0),
        APCI_MAKE_ENTRY(PCIe_DIO_24DC,0,0),
        APCI_MAKE_ENTRY(PCIe_DIO_24DCS,0,0),
        ...
        APCI_MAKE_ENTRY(PCI_DIO_24D_C,0,0),
        APCI_MAKE_ENTRY(PCI_DIO_24S,0,0),
        APCI_MAKE_ENTRY(PCI_DIO_48,0,0),
        APCI_MAKE_ENTRY(PCI_DIO_48S,0,0),
        APCI_MAKE_ENTRY(P104_DIO_48S,0,0),
        APCI_MAKE_ENTRY(PCI_DIO_48H,0,0),
        APCI_MAKE_ENTRY(PCI_DIO_48HS,0,0),
        APCI_MAKE_ENTRY(PCI_DIO_72,0,0),
        APCI_MAKE_ENTRY(P104_DIO_96,0,0),
        APCI_MAKE_ENTRY(PCI_DIO_96,0,0),
        APCI_MAKE_ENTRY(PCI_DIO_96CT,0,0),
        APCI_MAKE_ENTRY(PCI_DIO_96C3,0,0),
        APCI_MAKE_ENTRY(PCI_DIO_120,0,0),
        APCI_MAKE_ENTRY(PCI_AI12_16,0,0),
        APCI_MAKE_ENTRY(PCI_AI12_16_,0,0),
        APCI_MAKE_ENTRY(PCI_AI12_16A,0,0),
        APCI_MAKE_ENTRY(PCI_AIO12_16,0,0),
        APCI_MAKE_ENTRY(PCI_A12_16A,0,0),
        APCI_MAKE_ENTRY(LPCI_A16_16A,0,0),
        APCI_MAKE_ENTRY(PCIe_DA16_16,0,0),
        APCI_MAKE_ENTRY(PCIe_DA16_8,0,0),
        APCI_MAKE_ENTRY(PCIe_DA16_6,0,0),
        APCI_MAKE_ENTRY(PCIe_DA16_4,0,0),
        APCI_MAKE_ENTRY(PCIe_DA16_2,0,0),
        APCI_MAKE_ENTRY(PCIe_DA12_16,0,0),
        APCI_MAKE_ENTRY(PCIe_DA12_8,0,0),
        APCI_MAKE_ENTRY(PCIe_DA12_6,0,0),
        APCI_MAKE_ENTRY(PCIe_DA12_4,0,0),
        APCI_MAKE_ENTRY(PCIe_DA12_2,0,0),
        APCI_MAKE_ENTRY(PCI_DA12_16,0,0),
        APCI_MAKE_ENTRY(PCI_DA12_8,0,0),
        APCI_MAKE_ENTRY(PCI_DA12_6,0,0),
        APCI_MAKE_ENTRY(PCI_DA12_4,0,0),
        APCI_MAKE_ENTRY(PCI_DA12_2,0,0),
        APCI_MAKE_ENTRY(PCI_DA12_16V,0,0),
        ...
        APCI_MAKE_ENTRY(PCI_WDG_2S,0,0),
        APCI_MAKE_ENTRY(PCI_WDG_CSM,0,0),
        APCI_MAKE_ENTRY(PCI_WDG_IMPAC,0,0),
        APCI_MAKE_ENTRY(MPCIE_DIO_24S,0,0),
        APCI_MAKE_ENTRY(MPCIE_DIO_24S_R1,0,0),
        APCI_MAKE_ENTRY(MPCIE_IDIO_8,0,0),
        APCI_MAKE_ENTRY(MPCIE_IIRO_8,1,1),
        APCI_MAKE_ENTRY(MPCIE_IDIO_4,0,0),
        APCI_MAKE_ENTRY(MPCIE_IIRO_4,0,0),
        APCI_MAKE_ENTRY(MPCIE_IDO_8,0,0),
        APCI_MAKE_ENTRY(MPCIE_RO_8,0,0),
        APCI_MAKE_ENTRY(MPCIE_II_16,0,0),
        APCI_MAKE_ENTRY(MPCIE_II_8,0,0),
        APCI_MAKE_ENTRY(MPCIE_II_4,0,0),
        APCI_MAKE_ENTRY(MPCIE_QUAD_4,0,0),
        APCI_MAKE_ENTRY(MPCIE_QUAD_8,0,0),

        APCI_MAKE_ENTRY(PCI_QUAD_8,0,0),
        APCI_MAKE_ENTRY(PCI_QUAD_4,0,0),


        APCI_MAKE_ENTRY(MPCIE_DIO_24,0,0),
        APCI_MAKE_ENTRY(PCI_WDG_IMPAC,0,0),
        // APCI_MAKE_ENTRY( MPCIE_DIO_24S ,0,0),
        APCI_MAKE_ENTRY(PCIe_IDIO_12,0,0),
        APCI_MAKE_ENTRY(PCIe_IDIO_24,0,0),

        APCI_MAKE_ENTRY(PCIe_ADIO16_16FDS,0,0),
        APCI_MAKE_ENTRY(PCIe_ADIO16_16F,0,0),
        APCI_MAKE_ENTRY(PCIe_ADIO16_16A,0,0),
        APCI_MAKE_ENTRY(PCIe_ADIO16_16E,0,0),
        APCI_MAKE_ENTRY(PCIe_ADI16_16F,0,0),
        APCI_MAKE_ENTRY(PCIe_ADI16_16A,0,0),
        APCI_MAKE_ENTRY(PCIe_ADI16_16E,0,0),
        APCI_MAKE_ENTRY(PCIe_ADIO12_16A,0,0),
        APCI_MAKE_ENTRY(PCIe_ADIO12_16,0,0),
        APCI_MAKE_ENTRY(PCIe_ADIO12_16E,0,0),
        APCI_MAKE_ENTRY(PCIe_ADI12_16A,0,0),
        APCI_MAKE_ENTRY(PCIe_ADI12_16,0,0),
        APCI_MAKE_ENTRY(PCIe_ADI12_16E,0,0),

        APCI_MAKE_ENTRY(mPCIe_AIO16_16FDS,0,0),
        APCI_MAKE_ENTRY(mPCIe_AIO16_16F,0,0),
        APCI_MAKE_ENTRY(mPCIe_AIO16_16A,0,0),
        APCI_MAKE_ENTRY(mPCIe_AIO16_16E,0,0),
        APCI_MAKE_ENTRY(mPCIe_AI16_16F,0,0),
        APCI_MAKE_ENTRY(mPCIe_AI16_16A,0,0),
        APCI_MAKE_ENTRY(mPCIe_AI16_16E,0,0),
        APCI_MAKE_ENTRY(mPCIe_AIO12_16A,0,0),
        APCI_MAKE_ENTRY(mPCIe_AIO12_16,0,0),
        APCI_MAKE_ENTRY(mPCIe_AIO12_16E,0,0),
        APCI_MAKE_ENTRY(mPCIe_AI12_16A,0,0),
        APCI_MAKE_ENTRY(mPCIe_AI12_16,0,0),
        APCI_MAKE_ENTRY(mPCIe_AI12_16E,0,0),
        APCI_MAKE_ENTRY(mPCIe_AIO16_16F_proto,0,0),
        APCI_MAKE_ENTRY(mPCIe_AIO16_16A_proto,0,0),
        APCI_MAKE_ENTRY(mPCIe_AIO16_16E_proto,0,0),
        APCI_MAKE_ENTRY(mPCIe_AI16_16F_proto,0,0),
        APCI_MAKE_ENTRY(mPCIe_AI16_16A_proto,0,0),
        APCI_MAKE_ENTRY(mPCIe_AI16_16E_proto,0,0),
        APCI_MAKE_ENTRY(mPCIe_AIO12_16A_proto,0,0),
        APCI_MAKE_ENTRY(mPCIe_AIO12_16_proto,0,0),
        APCI_MAKE_ENTRY(mPCIe_AIO12_16E_proto,0,0),
        APCI_MAKE_ENTRY(mPCIe_AI12_16A_proto,0,0),
        APCI_MAKE_ENTRY(mPCIe_AI12_16_proto,0,0),
        APCI_MAKE_ENTRY(mPCIe_AI12_16E_proto,0,0),
        APCI_MAKE_ENTRY(mPCIe_ADIO16_8FDS,0,0),
        APCI_MAKE_ENTRY(mPCIe_ADIO16_8F,0,0),
        APCI_MAKE_ENTRY(mPCIe_ADIO16_8A,0,0),
        APCI_MAKE_ENTRY(mPCIe_ADIO16_8E,0,0),
        APCI_MAKE_ENTRY(mPCIe_ADI16_8F,0,0),
        APCI_MAKE_ENTRY(mPCIe_ADI16_8A,0,0),
        APCI_MAKE_ENTRY(mPCIe_ADI16_8E,0,0),
        APCI_MAKE_ENTRY(mPCIe_ADIO12_8A,0,0),
        APCI_MAKE_ENTRY(mPCIe_ADIO12_8,0,0),
        APCI_MAKE_ENTRY(mPCIe_ADIO12_8E,0,0),
        APCI_MAKE_ENTRY(mPCIe_ADI12_8A,0,0),
        APCI_MAKE_ENTRY(mPCIe_ADI12_8,0,0),
        APCI_MAKE_ENTRY(mPCIe_ADI12_8E,0,0),
        APCI_MAKE_ENTRY(PCIe_DIO_24HC,0,0),
        APCI_MAKE_ENTRY(PCIe_DIO_72,0,0),
        APCI_MAKE_ENTRY(PCIe_DIO_96,0,0),
        APCI_MAKE_ENTRY(PCIe_DIO_120,0,0), );
