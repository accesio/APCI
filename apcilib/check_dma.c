...
//volatile static uint16_t ring_buffer[RING_BUFFER_SLOTS][FIFO_SIZE * 2];
...
void * worker_main(void *arg)
{
	...
	do
	{
		if (1) printf("  Worker Thread: About to call apci_dma_data_ready()\n");
		fflush(stdout);
